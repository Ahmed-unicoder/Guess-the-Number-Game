...
while True:
    ...
    if Num == Random: # If the Random Number is guessed correctly
        ...
        Count += 1
        Display()
    Continue = input("Please, press \"1\" if want to start a new game, else press any key to quit\n")
    if Continue != "1": # game ends if user presses any key except for the "1"
        print("Thanks for playing :)")
        time.sleep(2)
        break
    else:
        clear_console() # the code console is cleared for a fresh start